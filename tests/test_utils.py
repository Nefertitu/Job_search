...
from src.utils import filter_vacancies, get_top_vacancies, sort_vacancies, user_interaction
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"backend", "разработчик"}, {"знание", "москва", "backend", "python", "разработчик"}, True),
    ],
)
def test_filter_vacancies_param_positive(
    search_words, vacancy_data, expected_out, vacancy_1: Vacancy, vacancy_2: Vacancy
):
    """
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"backend", "python", "разработчик"}, {"знание", "москва", "backend", "python", "разработчик"}, True),
    ],
)
def test_filter_vacancies_param_negative(
    search_words, vacancy_data, expected_out, vacancy_1: Vacancy, vacancy_2: Vacancy
):
    """
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"frontend", "python", "разработчик"}, {"знание", "москва", "backend", "python", "разработчик"}),
    ],
)
...
def test_user_interaction(mock_input, mock_requests_get, data_1, data_2, data_5, capsys):
    ...
    test_vacancies = [data_1, data_2, data_5]
